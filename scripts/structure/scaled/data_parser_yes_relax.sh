#!/usr/bin/env bash
# debug_data_parser_relax.sh — non-interactive parser for relaxation VASP calculations
...
# Pre-answered prompts: With relaxation, Copy XML
IS_RELAX=1
COPY_XML=1
echo "Configuration: Relaxation calculations (ionic relaxation), copying vasprun.xml files"
