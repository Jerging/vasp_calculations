#!/usr/bin/env bash
# debug_data_parser.sh — verbose parser for VASP calculations
...
# Ask user about relaxation
read -rp "Do these calculations undergo relaxation? (y/n): " is_relaxation
[[ $is_relaxation =~ ^[Yy]$ ]] && IS_RELAX=1 || IS_RELAX=0
